...
class PAGHeaderView: UIView {
    ...
    init(infoDic : [String:Any]) {
        ...
        if dayTypeString == "1" {
            ...
            monthLabel = UILabel(frame: CGRect(x: 0, y: 5, width: SCREEN.WIDTH, height: 30))
            ...
            monthLabel?.font = UIFont(name: Nanum_Barun_Gothic_OTF_Bold, size: 14)
...
class DayViewButton: UIButton {
    ...
    init(infoDic : [String:Any], index : Int) {
        ...
        weekLabel.font = UIFont(name: Nanum_Barun_Gothic_OTF_Bold, size: 13)
        ...
        dayLabel.font = UIFont(name: Nanum_Barun_Gothic_OTF, size: 13)
