...
@objc protocol QuestionSelectViewDelegate {
    @objc optional func questionSelectView(questionSelectView : QuestionSelectView, selectQuestionUpdate indexPath: IndexPath)
}

class QuestionSelectView: UIView {
    
    weak var delegate : QuestionSelectViewDelegate?
    ...
    init(frame: CGRect, questionDataArray kQuestionDataArray : [[String:Any]]) {
        ...
        titleLabel.font = UIFont(name: Nanum_Barun_Gothic_OTF, size: 20)
...
extension QuestionSelectView : UITableViewDataSource, UITableViewDelegate, QuestionSelectTableViewHeaderDelegate {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        self.delegate?.questionSelectView?(questionSelectView: self, selectQuestionUpdate: indexPath)
...
class QuestionSelectTableViewCell: UITableViewCell {
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        checkButton.setImage(UIImage(named: "btn.png"), for: .normal)
        checkButton.setImage(UIImage(named: "btn_o.png"), for: .selected)
