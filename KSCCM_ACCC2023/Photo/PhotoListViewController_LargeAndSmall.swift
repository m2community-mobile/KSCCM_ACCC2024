...
//    static let INFO = [
//        [
//            KEY.TITLE : "March 12(Thu)",
//            KEY.TAB : "274"
//        ],
//        [
//            KEY.TITLE : "March 13(Fri)",
//            KEY.TAB : "275"
//        ],
//        [
//            KEY.TITLE : "March 14(Sat)",
//            KEY.TAB : "276"
//        ],
////        [
////            KEY.TITLE : "사용자 사진",
...
//            photoListSelectButton.tab = PHOTO_LIST_INFO.INFO[i][PHOTO_LIST_INFO.KEY.TAB] ?? ""
...
//                y: segBackView.frame.maxY,
//                width: SCREEN.WIDTH,
//                height: SCREEN.HEIGHT - self.segBackView.frame.maxY - SAFE_AREA),
//            collectionViewLayout: collectionViewLayout)
//        
...
//        
//        //notUsingBottomView
//        //        addNewImageButton = IconButtonWithBottom(frame: CGRect(x: 0, y: SCREEN.HEIGHT, width: SCREEN.WIDTH, height: addNewImageButtonHeight + SAFE_AREA), name: "사진 추가", fontAwesome: .camera, fontAwesomeStyle: .solid)
//        
//        //usingBottomView
...
//        let tab = PHOTO_LIST_INFO.INFO[index][PHOTO_LIST_INFO.KEY.TAB] ?? ""
//        
//        currentIndex = index
//        
...
//                                smallArrayIndex += 1
//                            }else{
//                                print("예외? smallArrayIndex \(smallArrayIndex)")
//                            }
//                        }
//                    }
//                    
...
//            
//            //notUsingBottomView
//            //            if self.photoListSelectButtons[index].tab == "-1" {
...
//        underBar.backgroundColor = mainColor
