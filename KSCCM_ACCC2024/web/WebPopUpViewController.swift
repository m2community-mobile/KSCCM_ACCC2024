...
,WKNavigationDelegate , WKUIDelegate
{
    ...
    let isShowableTypes = ["jpg","doc","docx","png","ppt","pptx","xlsx","xls"]
    let notShowableTypes = ["hwp","gif","ai"]
    ...
    override func viewWillTransition(to size: CGSize, with coordinator: UIViewControllerTransitionCoordinator) {
        ...
        UIView.animate(withDuration: coordinator.transitionDuration) {
            self.wkWebView.frame = CGRect(origin: CGPoint.zero, size: size)
//            self.uiUpdate(size: size)
    ...
    override func viewDidLoad() {
        ...
        print("WebPopUpViewController viewdidload")
        ...
        self.wkWebView = WKWebView(
            frame: CGRect(x: 0, y: STATUS_BAR_HEIGHT, width: SCREEN.WIDTH, height: SCREEN.HEIGHT - STATUS_BAR_HEIGHT - SAFE_AREA),
...
extension WebPopUpViewController : MFMailComposeViewControllerDelegate,UINavigationControllerDelegate {
