...
class BottomSubView: UIView {
    ...
    class BottomSubViewCloseButton: UIView {
        ...
        override init(frame: CGRect) {
            ...
            self.backgroundColor = #colorLiteral(red: 0.01190177165, green: 0.496769309, blue: 0.5953115225, alpha: 1)
    ...
    class PopUpView: UIView {
        ...
        let titles = [
            "Program at a glance",
            "April 24 (Wed):pre-Congress Workshop",
            "April 25 (Thu)",
            "April 26 (Fri)",
            "KSCCM-TSCCM/TSECCM Joint Session",
            "Luncheon Symposium",
        ]
        ...
        init(delegate kDelegate : BottomSubPopUpViewDelegate, flipView : UIView) {
            ...
            innerView.backgroundColor = #colorLiteral(red: 0.02266478911, green: 0.4768964052, blue: 0.5713348985, alpha: 1)
...
//            innerView.backgroundColor = UIColor.red
        ...
        class ContentView: UIView {
            ...
            init(frame: CGRect, title : String) {
                ...
                label.text = "\(title)"
                label.font = UIFont(name: Pretendard_Bold, size: 12)
