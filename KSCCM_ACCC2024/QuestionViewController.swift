...
class QuestionViewController: UIViewController, QuestionSelectViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        selectButton.addTarget(event: .touchUpInside) { [weak self] (butotn) in
            guard let self = self else { return }
            ...
            if self.questionSelectView == nil {
                ...
                self.questionSelectView?.delegate = self
    ...
    func questionSelectView(questionSelectView: QuestionSelectView, selectQuestionUpdate indexPath: IndexPath) {
